...
//save users details
$query = "INSERT into `users` (username,password,fullname,email,lastaccess,last_ip,status,photo)
VALUES ('$username','$password','$fullname','$email','Nill','Nill','1','upload/images.png')";
