...
$staffID = mysqli_real_escape_string($conn,$_POST['txtstaffID']);
...
$_SESSION['error'] =' Staff With Staff ID Already Exist ';

}else{


//save staff details
$query = "INSERT into `tblstaff` (staffID,fullname,password,sex,phone,dept,staff_type,date_appointment,qualification,date_reg,status,unit,photo)
VALUES ('$staffID','$fullname','$password','$sex','080','Computer Science','nil','nil','nil','$current_date','$status','$unit','upload/default.jpg')";
  ...
  $_SESSION['error'] ='Problem Adding Staff';
}
}
}
...
return  true;
  ...
  <script type="text/javascript">
		function deldata(){
if(confirm("ARE YOU SURE YOU WISH TO DELETE THIS STAFF ?" ))
{
return  true;
}
else {return false;
              ...
              <form id="form" action="" method="post" class="">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtstaffID" id="exampleInputEmail1" size="77" value="S/AT/" placeholder="Enter Reg No.">
                  </div>
              ...
              <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tr> <th width="3%"><div align="center">#</div></th>
                        <th width="13%"><div align="center">Fullname</div></th>
                        <th width="13%"><div align="center">Password</div></th>
                        <th width="13%"><div align="center">Staff ID</div></th>
							          <th width="8%"><div align="center">Staff Type</div></th>
                        <th width="7%"><div align="center">Phone</div></th>
                        <th width="6%"><div align="center">Photo</div></th>
                    ...
                    <tbody>
                                         <?php 
                                          $sql = "SELECT * FROM tblstaff order by ID ASC";
                                           $result = $conn->query($sql); 
										$cnt=1;
                    ...
                    <td><div align="center"><?php echo $row['staff_type']; ?></div></td>
                    ...
                    <div class="dropdown-menu" role="menu">
							        <a class="dropdown-item" href="delete-staff.php?id=<?php echo $row['ID'];?>" onClick="return deldata();">Delete</a>
                      <?php if (($row['status'])==(('1')))  { ?>
                      <a class="dropdown-item" href="block-unblock-staff.php?id=<?php echo $row['ID'];?>" onClick="return Deactivate('<?php echo $row['fullname']; ?> ');">Deactivate</a>
					  <?php } else {?>
					  <a class="dropdown-item" href="block-unblock-staff.php?uid=<?php echo $row['ID'];?>" onClick="return Activate('<?php echo $row['fullname']; ?> ');">Activate</a>
					  <?php } ?>
                    </div>
                  </div>
                </td>
