...
{ 
 // it return number of rows in the table. 
 $row_staff= mysqli_num_rows($result); 
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-warning elevation-1"><i class="fa fa-users" id="icon"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">No. Of Staff </span>
                <span class="info-box-number">
                  <?php  echo $row_staff;   ?>
                  <small></small>
                </span>
            ...
            <!-- /.info-box -->
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-info elevation-1"><i class="fa fa-edit" id="icon"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">IP Address </span>
                <span class="info-box-number">
                <?php  echo $row2['last_ip'];   ?>
                  <small></small>
                </span>
              </div>
              <!-- /.info-box-content -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-danger elevation-1"><i class="fa fa-signin" id="icon"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Last Login </span>
                <span class="info-box-number">
                  <?php  echo $row2['lastaccess'];   ?>
                  <small></small>
                </span>
              </div>
              <!-- /.info-box-content -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-info elevation-1"><i class="fa fa-dollar" id="icon"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">SMS balance</span>
                <span class="info-box-number">
                NGN<?php echo number_format((float) $response->balance ,2); ?>
                  <small></small>
                </span>
              </div>
              <!-- /.info-box-content -->
...
$sql = "SELECT * FROM tblstudent ORDER BY ID DESC LIMIT 8;";
$result = $conn->query($sql);
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list clearfix">
                      <li>
                        ...
                        <span class="users-list-date"><?php echo $row_new_students['admissionID'];  ?></span>
                      </li>
					   <?php    }  ?>
                    </ul>
