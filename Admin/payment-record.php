...
<head>
  ...
  <title>Subscription Record|Dashboard</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Subscription Record</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <th width="10%"><div align="center">Fullname</div></th>
                        ...
                        <th width="5%"><div align="center">Date Paid</div></th>
                    ...
                    <tbody>
                                      <?php 
                                     $sql = "SELECT * FROM tblpayment order by ID ASC ";
                      ...
                      <tr class="gradeX">
                        ...
                        <td height="50"><div align="center"><?php echo $row['user']; ?> </div></td>
                        <td><div align="center">NGN<?php echo number_format((float) $row['amount'] ,2); ?></div></td>
                        <td><div align="center"></div><?php echo $row['date_paid']; ?></td>
