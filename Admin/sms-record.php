...
<head>
  ...
  <title>SMS Record|Dashboard</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">SMS Record</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <td width="1090" height="184"><div class="card">
                ...
                <div class="card-body">
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <th width="10%"><div align="center">SMS type</div></th>
                        <th width="5%"><div align="center">Sender ID</div></th>
                        <th width="5%"><div align="center">Sender</div></th>
                        <th width="5%"><div align="center">Message</div></th>
                    ...
                    <tbody>
                                      <?php 
                //  $sql = "SELECT *, FROM tblsms INNER JOIN tblstaff ON tblsms.sender=tblstaff.staffID  LEFT JOIN tblstudent ON tblsms.sender=tblstudent.regnum";
                  $sql = "SELECT * FROM tblsms ";
                      ...
                      <tr class="gradeX">
                        ...
                        <td height="50"><div align="center"><?php echo $row['sms_type']; ?> </div></td>
                        <td><div align="center"><?php echo $row['senderID']; ?></div></td>
                        <td><div align="center"></div><?php echo $row['sendername']; ?></td>
                        <td height="50"><div align="center"><?php echo $row['msg']; ?> </div></td>
                        <td><div align="center"><?php echo $row['phone']; ?></div></td>
                        <td><div align="center"></div><?php echo $row['date_sent']; ?></td>
                        <td height="50"><div align="center"><?php echo $row['status']; ?> </div></td>
