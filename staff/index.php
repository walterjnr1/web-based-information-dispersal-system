...
<head>
  ...
  <meta name="description" content="Responsive HTML Admin Dashboard Template based on Bootstrap 5">
	...
	<title>Staff Dashboard -  WEB-BASED INFROMATION DISPERSAL MANAGEMENT SYSTEM FOR TERTIARY INSTITUTIONS</title>
	...
	<div class="main-wrapper">
      ...
      ?>
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">Welcome <?php echo $row_staff['fullname'] ?> </h4>
          </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                      ...
                      <?php
$query = "SELECT * FROM tblsms where sender='$staffID' "; 
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-5">
                        <h4 class="mb-2">NGN<?php echo number_format((float) $row_staff['unit'] ,2); ?></h4>
                        <div class="d-flex align-items-baseline">
                          <p class="text-success">
                            <span></span></p>
