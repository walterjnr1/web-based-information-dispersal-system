...
}else if($mobile !== "" || $message !== "" || $senderID == "" ){
...
$data = array('username'=>$username, 'password'=>$password,'sender'=>$senderID, 'message'=>$message, 'mobiles'=>$mobile);
...
$sql = "update  tblstaff set unit = (unit) - $result->price  where staffID= '$staffID'";
...
<head>
  ...
  <meta name="description" content="Responsive HTML Admin Dashboard Template based on Bootstrap 5">
	...
	<title>SMS -  WEB-BASED INFROMATION DISPERSAL MANAGEMENT SYSTEM FOR TERTIARY INSTITUTIONS</title>
			...
			<div class="page-content">
				...
				<nav class="page-breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Compose SMS</li>
					</ol>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="row mb-3">
									...
									<div class="col-lg-8">
									<span class="badge bg-info">NGN<?php echo number_format((float) $rowaccess['unit'] ,2); ?></span>
									</div>
								</div>
								...
								<div class="row mb-3">
									<div class="col-lg-3">
										<label for="defaultconfig-3" class="col-form-label">Recipient</label>
									</div>
									<div class="col-lg-8">
									<?php
			$sql = "select DISTINCT phone from tblstaff";
             $group = $dbh->query($sql);                       
             $group->setFetchMode(PDO::FETCH_ASSOC);
             echo '<select name="cmdphone"  id="cmdphone" class="form-select" >';
